<%-- 
    ...
    Created on : 24 nov. 2023, 09:53:42
                    ...
                    <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
                        <ul id="sidebarnav">
                            <li class="nav-small-cap">
                                ...
                                <span class="hide-menu">GESTION ARTICLE</span>
                            </li>
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link" href="./mouvement" aria-expanded="false">
                                    ...
                                    <span class="hide-menu">Mouvement</span>
                                </a>
                            </li>
                            <li class="sidebar-item">
                                <a class="sidebar-link" href="./etat-stock" aria-expanded="false">
                                    <span>
                                        <i class="ti ti-aperture"></i>
                                    </span>
                                    <span class="hide-menu">Etat de stock</span>
                                </a>
                            </li>
                            <li class="nav-small-cap">
                                <i class="ti ti-dots nav-small-cap-icon fs-4"></i>
                                <span class="hide-menu">DEMANDE CLIENT</span>
                            </li>
                            <li class="sidebar-item">
                                <a class="sidebar-link" href="./proforma-request" aria-expanded="false">
                                    <span>
                            ...
                            <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
                                <li class="nav-item dropdown">
                                    <a class="nav-link nav-icon-hover" href="javascript:void(0)" id="drop2" data-bs-toggle="dropdown"
                                       aria-expanded="false">
                                        <img src="./assets/images/profile/<%= user.getPhoto() %>" alt="" width="60" height="35" class="rounded-circle">
                                    </a>
